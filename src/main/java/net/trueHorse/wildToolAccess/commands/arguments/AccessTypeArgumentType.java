...
public class AccessTypeArgumentType implements ArgumentType<AccessTypeArgument>{
    ...
    private static final SimpleCommandExceptionType MISSING_TYPE = new SimpleCommandExceptionType(new TranslatableComponent("argument.wildtoolaccess.type_to_access.missing"));
    private static final DynamicCommandExceptionType TYPE_UNKNOWN = new DynamicCommandExceptionType(input -> new TranslatableComponent("argument.wildtoolaccess.type_to_access.unknown",input));
